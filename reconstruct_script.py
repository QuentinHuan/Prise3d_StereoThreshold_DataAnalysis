...
sceneList=["p3d_arcsphere","p3d_contemporary-bathroom","p3d_caustic-view0","p3d_crown","p3d_indirect"] # list 1
sceneList=sceneList+["p3d_kitchen-view0","p3d_kitchen-view1","p3d_landscape-view3","p3d_sanmiguel-view1","p3d_sanmiguel-view2"] # list 2
sceneList=["p3d_kitchen-view1"] # for quick testing
...
def rebuild_Images(type="stereo",showData = False):
    ...
    for s in sceneList:
        ...
        # reconstruction
        for i in ListOfPov:
            out.reconstruct_thresholdImage(T,path,imagePath,resolution,resolution,str(i),method="nearest",show=False)
...
rebuild_Images(type="8pov",showData=True)
plt.show()
